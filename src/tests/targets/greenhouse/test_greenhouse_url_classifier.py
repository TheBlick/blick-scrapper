...
class TestGreenhouseUrlClassifier(unittest.TestCase):
    ...
    def test_should_approve_merge_when_it_is_compliant(self):
        with (
            patch("targets.greenhouse.greenhouse_url_classifier.GreenhouseBoardParser.extract_greenhouse_job_info") as parser,
            patch("targets.greenhouse.greenhouse_job_board_parser.requests") as req,
        ):
            parser.return_value = [ {'url': 'https://boards.greenhouse.io/fixture_board_company/jobs/4362194005',
            ...
            assert urls == [{'url': 'https://boards.greenhouse.io/fixture_board_company/jobs/4362194005', 'origin_url': 'https://boards.greenhouse.io/companyname', 'origin_category': 'job_board', 'target_name': 'greenhouse', 'company_name': 'companyname', 'job_id': '4362194005', 'title': 'Geospatial Data Scientist', 'location': 'LATAM - Remote'},
                            {'url': 'https://boards.greenhouse.io/random_company/jobs/123', 'origin_url': 'https://boards.greenhouse.io/random_company/jobs/123', 'origin_category': 'job_posting', 'target_name': 'greenhouse', 'company_name': 'random_company', 'job_id': '123'}]
